...
<Info>
**Want instant access without building anything?** The API now includes a [built-in MCP server](/mcp) with 13 tools at `api.urantia.dev/mcp`. Add it to Claude Desktop or any MCP client in one line. This tutorial is for building a **custom** MCP server with your own logic.
</Info>
