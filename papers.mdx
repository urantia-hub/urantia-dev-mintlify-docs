...
Add `?include=topEntities` to attach a per-paper aggregate of the most-cited named entities — sorted by paragraph frequency and tier-ranked so beings, places, and concepts surface before orders, races, and religions:
