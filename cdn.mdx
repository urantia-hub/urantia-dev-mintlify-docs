...
sidebarTitle: "CDN"
description: "Access static JSON, audio, entities, and embeddings from audio.urantia.dev — the Cloudflare R2-backed CDN powering the Urantia Papers API."
---

All static data that powers the API is available directly from a public Cloudflare R2 bucket at `audio.urantia.dev`. You can use these files for offline apps, custom pipelines, or self-hosted setups.
...
```bash
# Foreword
https://audio.urantia.dev/json/eng/000.json

# Paper 1 — The Universal Father
https://audio.urantia.dev/json/eng/001.json

# Paper index (all papers, sections, paragraphs)
https://audio.urantia.dev/json/eng/index.json

# Part metadata
https://audio.urantia.dev/json/eng/1-part.json
```
...
https://audio.urantia.dev/entities/seed-entities.json

# Paragraph-to-entity citation mappings
https://audio.urantia.dev/entities/paragraph-entities.json
```
...
https://audio.urantia.dev/embeddings/embeddings.json
```
...
https://audio.urantia.dev/manifests/audio-manifest.json
```
